...
//       Location loc;
//       loc.lat = gps.mylocation(i).lat;
//       loc.lng = 1491652300;
//       loc.alt = gps.num_sensors()*1000;
//       Vector3f vel(0,0,0);
//       
//       current_loc = loc;
//       gps.setHIL(i, AP_GPS::GPS_OK_FIX_3D, gps.time_epoch_usec(i)/1000.0, loc, vel, gps.num_sats(i), gps.get_hdop(i), true);
//     }
